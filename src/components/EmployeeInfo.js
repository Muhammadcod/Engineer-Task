      ...
      {employees.map((user) => (
        <tr key={user.id} className="employee-info">
          ...
          <td className="location">
            <span className="d-block location--city">{user.city}</span>
            <span className="location--address">{user.address}</span>
          </td>
          <td className="status">
            {user.status > 1 ? (
              <span className="badge badge-pill border orange" style={{ background: `#FFF6DE` }}>
              ...
              <span className="badge badge-pill border purple" style={{ background: `#F6F3FF` }}>
                No issue
              </span>
            )}
          </td>
          <td className="entries">
            <ul className="exception">
              <li>{user.entries} Unique Entries</li>
            </ul>
            Homogenous
          </td>
          <td className="risk--profile">
            {user.risk <= 8 ? (
              <span className="green">
                <FiArrowDownRight /> Low Risk
              </span>
            ) : user.risk > 8 && user.risk <= 14 ? (
              <span className="blue">
                <FiArrowRight /> Mid Risk
              </span>
            ) : (
              <span className="red">
                <FiArrowUp /> High Risk
